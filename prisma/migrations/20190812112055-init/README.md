# Migration `20190812112055-init`

This migration has been generated by Jake Flynn at 8/12/2019, 11:20:55 AM.
...
You can use a specific Photon built for this migration (20190812112055-init)
in your `before` or `after` migration script like this:

```ts
import Photon from '@generated/photon/20190812112055-init'
